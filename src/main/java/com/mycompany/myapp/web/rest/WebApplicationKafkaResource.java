...
@RestController
@RequestMapping("/api/web-application-kafka")
public class WebApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(WebApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebApplicationKafkaResource(KafkaProperties kafkaProperties) {
