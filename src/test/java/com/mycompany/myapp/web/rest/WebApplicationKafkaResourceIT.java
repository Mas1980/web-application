...
class WebApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        WebApplicationKafkaResource kafkaResource = new WebApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/web-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/web-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
